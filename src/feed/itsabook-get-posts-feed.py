...
def lambda_handler(event, context, neo4j_session=None):
    try:
        ...
        posts = [
            {
                'id': record['p']['id'],
                'reviewText': record['p']['reviewText'],
                'link': record['p']['link'],
                'previewLink': record['p']['previewLink'],
                'image': record['p']['image'],
                'title': record['p']['title'],
                'subtitle': record['p']['subtitle'],
                'description': record['p']['description'],
                'ratingValue': record['p']['ratingValue'],
                'createdAt': record['p']['createdAt'],
